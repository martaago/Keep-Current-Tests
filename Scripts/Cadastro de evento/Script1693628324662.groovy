...
WebUI.setText(findTestObject('Object Repository/Page_Keep Current/input_Course_name'), 'Palestra')

WebUI.setText(findTestObject('Object Repository/Page_Keep Current/input_Data de incio_rf'), '2023/11/16 09:00')

WebUI.setText(findTestObject('Object Repository/Page_Keep Current/input_Data de trmino_rh'), '2023/11/14 12:00')

WebUI.click(findTestObject('Object Repository/Page_Keep Current/button_add new event'))
